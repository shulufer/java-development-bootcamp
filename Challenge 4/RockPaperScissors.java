...
public class RockPaperScissors {
    ...
    */
              if (wantsToPlay.equals("yes")) {
                ...
                String computerChoice1 = computerChoice();
                String result = result(userChoice, computerChoice1);
                printResult(userChoice, computerChoice1, result);
              } else {
    ...
    public static String result(String yourChoice, String computerChoice) {
        ...
        (yourChoice.equals("paper") && computerChoice.equals("paper"))){
          result = "You lose. But it is equal. Because we don't know loop yet.";
        } else {
     ...
     *      – prints: <result>
     */
      public static void printResult(String yourChoice, String computerChooice, String result) {
        System.out.println("\nYou chose:\t" + yourChoice);
        System.out.println("The computer chose:\t" + computerChooice);
